...
Deno.serve(async () => {
  const manifest = {
    ...
    screenshots: [
      {
        src: "https://media.base44.com/images/public/6a05d76723afe58d80c589e8/90d27b0f1_BCObc7bb469-f8ce-4d13-b0bd-1d6f9d4206f1.png?v=20260626_726",
        sizes: "1024x1024",
        type: "image/png",
        form_factor: "narrow",
      ...
      {
        src: "https://media.base44.com/images/public/6a05d76723afe58d80c589e8/74f9ab6b0_BCOf0297029-2e38-446b-bd58-076244d9d764.png?v=20260626_726",
        sizes: "1024x683",
        type: "image/png",
        form_factor: "wide",
