...
'window.addEventListener(\'load\',function(){try{console.log(\'[LEGACY] Window loaded, books:\',METADATA.books.length);var loadingDiv=document.getElementById(\'bible-loading\');var errorDiv=document.getElementById(\'bible-error\');var contentDiv=document.getElementById(\'bible-content\');if(METADATA.books&&METADATA.books.length>0){loadingDiv.style.display=\'none\';contentDiv.style.display=\'block\';var statusDiv=document.getElementById(\'status\');statusDiv.innerHTML=\'<div class="status success">✓ Ready (\'+METADATA.books.length+\' books)</div>\';populateBooks();}else{console.error(\'[LEGACY] No books loaded\');loadingDiv.style.display=\'none\';errorDiv.style.display=\'block\';}}catch(e){console.error(\'[LEGACY] Load error:\',e);var loadingDiv2=document.getElementById(\'bible-loading\');var errorDiv2=document.getElementById(\'bible-error\');if(loadingDiv2)loadingDiv2.style.display=\'none\';if(errorDiv2)errorDiv2.style.display=\'block\';}});setTimeout(function(){try{var loadingDiv=document.getElementById(\'bible-loading\');var contentDiv=document.getElementById(\'bible-content\');if(loadingDiv&&loadingDiv.style.display!==\'none\'&&METADATA.books&&METADATA.books.length>0){loadingDiv.style.display=\'none\';contentDiv.style.display=\'block\';var statusDiv=document.getElementById(\'status\');statusDiv.innerHTML=\'<div class="status success">✓ Ready (\'+METADATA.books.length+\' books)</div>\';populateBooks();}}catch(e){}},500);' +
'</script>' +
'</body>' +
'</html>';
