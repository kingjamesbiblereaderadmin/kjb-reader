...
(function () {
  ...
  var readCache = function(){ try { return localStorage.getItem(CACHE_KEY); } catch (e) { return null; } };
  var writeCache = function(text){ try { localStorage.setItem(CACHE_KEY, text); } catch (e) { } };
  var showCacheBadge = function(){ cacheBadge.style.display = "block"; };
