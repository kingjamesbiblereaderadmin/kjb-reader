...
(function () {
  ...
  var availableBooks = [];
  var parseBible = function(text){ allBooks = []; var lines = text.split(/\\r?\\n/); var currentBook = null; var currentChapter = null; var currentVerse = null; var currentText = ""; var bookTitle = null; function saveVerse(){ if(currentBook!==null && currentChapter!==null && currentVerse!==null){ var text = currentText.replace(/\\[([^\\]]+)\\]/g, '<em class="ital">$1</em>'); allBooks.push({ book: currentBook, chapter: currentChapter, verse: currentVerse, text: text }); } currentVerse = null; currentText = ""; } for(var i=0;i<lines.length;i++){ var line = lines[i]; var bookMatch = line.match(/^THE (FIRST|SECOND|THIRD|FOURTH|FIFTH|SIXTH|SEVENTH|EIGHTH|NINTH|TENTH|ELEVENTH|TWELFTH|THIRTEENTH|FOURTEENTH|FIFTEENTH|SIXTEENTH|SEVENTEENTH|EIGHTEENTH|NINETEENTH|TWENTIETH) BOOK OF ([A-Z]+),? CALLED ([A-Z ]+)\\.$/); if(bookMatch){ if(currentBook!==null){ saveVerse(); } currentBook = bookMatch[3].trim(); if(currentBook==="GENESIS") currentBook="Genesis"; else if(currentBook==="EXODUS") currentBook="Exodus"; else if(currentBook==="LEVITICUS") currentBook="Leviticus"; else if(currentBook==="NUMBERS") currentBook="Numbers"; else if(currentBook==="DEUTERONOMY") currentBook="Deuteronomy"; else if(currentBook==="JOSHUA") currentBook="Joshua"; else if(currentBook==="JUDGES") currentBook="Judges"; else if(currentBook==="RUTH") currentBook="Ruth"; else if(currentBook==="1 SAMUEL") currentBook="1 Samuel"; else if(currentBook==="2 SAMUEL") currentBook="2 Samuel"; else if(currentBook==="1 KINGS") currentBook="1 Kings"; else if(currentBook==="2 KINGS") currentBook="2 Kings"; else if(currentBook==="1 CHRONICLES") currentBook="1 Chronicles"; else if(currentBook==="2 CHRONICLES") currentBook="2 Chronicles"; else if(currentBook==="EZRA") currentBook="Ezra"; else if(currentBook==="NEHEMIAH") currentBook="Nehemiah"; else if(currentBook==="ESTHER") currentBook="Esther"; else if(currentBook==="JOB") currentBook="Job"; else if(currentBook==="PSALMS") currentBook="Psalms"; else if(currentBook==="PROVERBS") currentBook="Proverbs"; else if(currentBook==="ECCLESIASTES") currentBook="Ecclesiastes"; else if(currentBook==="SONG OF SOLOMON") currentBook="Song of Solomon"; else if(currentBook==="ISAIAH") currentBook="Isaiah"; else if(currentBook==="JEREMIAH") currentBook="Jeremiah"; else if(currentBook==="LAMENTATIONS") currentBook="Lamentations"; else if(currentBook==="EZEKIEL") currentBook="Ezekiel"; else if(currentBook==="DANIEL") currentBook="Daniel"; else if(currentBook==="HOSEA") currentBook="Hosea"; else if(currentBook==="JOEL") currentBook="Joel"; else if(currentBook==="AMOS") currentBook="Amos"; else if(currentBook==="OBADIAH") currentBook="Obadiah"; else if(currentBook==="JONAH") currentBook="Jonah"; else if(currentBook==="MICAH") currentBook="Micah"; else if(currentBook==="NAHUM") currentBook="Nahum"; else if(currentBook==="HABAKKUK") currentBook="Habakkuk"; else if(currentBook==="ZEPHANIAH") currentBook="Zephaniah"; else if(currentBook==="HAGGAI") currentBook="Haggai"; else if(currentBook==="ZECHARIAH") currentBook="Zechariah"; else if(currentBook==="MALACHI") currentBook="Malachi"; else if(currentBook==="MATTHEW") currentBook="Matthew"; else if(currentBook==="MARK") currentBook="Mark"; else if(currentBook==="LUKE") currentBook="Luke"; else if(currentBook==="JOHN") currentBook="John"; else if(currentBook==="ACTS") currentBook="Acts"; else if(currentBook==="ROMANS") currentBook="Romans"; else if(currentBook==="1 CORINTHIANS") currentBook="1 Corinthians"; else if(currentBook==="2 CORINTHIANS") currentBook="2 Corinthians"; else if(currentBook==="GALATIANS") currentBook="Galatians"; else if(currentBook==="EPHESIANS") currentBook="Ephesians"; else if(currentBook==="PHILIPPIANS") currentBook="Philippians"; else if(currentBook==="COLOSSIANS") currentBook="Colossians"; else if(currentBook==="1 THESSALONIANS") currentBook="1 Thessalonians"; else if(currentBook==="2 THESSALONIANS") currentBook="2 Thessalonians"; else if(currentBook==="1 TIMOTHY") currentBook="1 Timothy"; else if(currentBook==="2 TIMOTHY") currentBook="2 Timothy"; else if(currentBook==="TITUS") currentBook="Titus"; else if(currentBook==="PHILEMON") currentBook="Philemon"; else if(currentBook==="HEBREWS") currentBook="Hebrews"; else if(currentBook==="JAMES") currentBook="James"; else if(currentBook==="1 PETER") currentBook="1 Peter"; else if(currentBook==="2 PETER") currentBook="2 Peter"; else if(currentBook==="1 JOHN") currentBook="1 John"; else if(currentBook==="2 JOHN") currentBook="2 John"; else if(currentBook==="3 JOHN") currentBook="3 John"; else if(currentBook==="JUDE") currentBook="Jude"; else if(currentBook==="REVELATION") currentBook="Revelation"; currentChapter = null; currentVerse = null; currentText = ""; continue; } var chapMatch = line.match(/^CHAPTER (\\d+)$/); if(chapMatch){ saveVerse(); currentChapter = chapMatch[1]; currentVerse = null; currentText = ""; continue; } if(currentChapter!==null){ var verseMatch = line.match(/^(\\d+)\\s+(.*)$/); if(verseMatch){ saveVerse(); currentVerse = verseMatch[1]; currentText = verseMatch[2]; } else if(currentVerse!==null && line.trim()!==""){ currentText += (currentText ? " " : "") + line; } } } saveVerse(); availableBooks = []; var seen = {}; for(var j=0;j<allBooks.length;j++){ var b = allBooks[j].book; if(!seen[b]){ availableBooks.push(b); seen[b] = true; } } var ordered = []; for(var k=0;k<BOOK_ORDER.length;k++){ if(seen[BOOK_ORDER[k]]){ ordered.push(BOOK_ORDER[k]); } } if(ordered.length>0){ availableBooks = ordered; } };
  var bookSel = null;
  var chapSel = null;
  var contentDiv = null;
  var refTitle = null;
