...
export default function AppLayout() {
  ...
  return (
    ...
    <div className="h-screen [height:100dvh] bg-gradient-to-br from-background via-accent/5 to-background flex flex-col overflow-hidden">
      <header className={`print:hidden border-b border-border/60 bg-card/70 backdrop-blur-xl z-50 flex-shrink-0 ${hideHeader ? 'hidden' : ''}`} style={{ paddingTop: 'max(env(safe-area-inset-top), 0.5rem)', paddingLeft: 'env(safe-area-inset-left)', paddingRight: 'env(safe-area-inset-right)' }}>
