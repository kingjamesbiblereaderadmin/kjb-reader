        ...
        <div className="max-w-5xl mx-auto px-4 h-[60px] sm:h-16 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 pointer-events-none">
            <button
              ...
              className="w-16 h-16 flex items-center justify-center rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary/80 active:bg-primary active:text-primary-foreground transition-colors pointer-events-auto touch-manipulation"
              aria-label="Refresh"
            >
