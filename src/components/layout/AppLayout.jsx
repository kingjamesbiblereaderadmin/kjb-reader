...
function BottomNav({ pathname, navigate }) {
  return (
    <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-[60] bg-card/95 backdrop-blur-md border-t border-border" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 0px)' }}>
