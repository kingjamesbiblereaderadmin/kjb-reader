        ...
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center gap-2">
          ...
          <div className="flex items-center gap-0.5 flex-shrink-0">
            <button
              ...
              className="min-w-[48px] min-h-[48px] p-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary active:bg-secondary transition-colors touch-manipulation flex items-center justify-center"
              aria-label="Refresh"
            >
