        ...
        <div className="max-w-5xl mx-auto px-4 h-[60px] sm:h-16 flex items-center gap-3">
          ...
          <div className="flex items-center gap-0.5 pointer-events-none">
            <button
              ...
              className="w-11 h-11 flex items-center justify-center rounded-lg bg-secondary border border-border text-muted-foreground hover:text-foreground hover:bg-secondary/80 active:bg-primary active:text-primary-foreground transition-colors touch-manipulation select-none pointer-events-auto"
              aria-label="Refresh"
            >
