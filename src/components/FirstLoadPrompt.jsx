  ...
  if (splashMode) {
    return (
      <div className="w-full pointer-events-auto px-1">
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-xl shadow-md p-3 space-y-2 relative">
          <div className="flex flex-col items-center justify-center gap-0 mb-1">
            <h2 className="font-serif text-sm font-bold text-foreground">Quick Setup</h2>
            <p className="font-sans text-[10px] text-muted-foreground text-center">Customize reading experience</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="rounded-lg bg-secondary/40 border border-border p-2">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="font-sans text-[11px] font-medium">Reading Font</span>
              </div>
                ...
                {READING_FONTS.map(font => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-1 py-1.5 rounded-md font-sans text-[10px] font-medium transition-all ${
            ...
            <div className="rounded-lg bg-secondary/40 border border-border p-2">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="font-sans text-[11px] font-medium">Font Accessibility</span>
              </div>
            ...
            <div className="rounded-lg bg-secondary/40 border border-border p-2">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="font-sans text-[11px] font-medium">Theme Color</span>
              </div>
