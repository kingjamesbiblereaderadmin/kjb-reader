...
export default function CurrentlyReadingIndicator({
  ...
  return (
    <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-yellow-500 text-black font-sans text-xs font-medium hover:bg-yellow-600 transition-all duration-200 h-11 whitespace-nowrap">
      <p className="font-sans text-xs font-medium text-black leading-tight">
