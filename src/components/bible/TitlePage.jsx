    ...
    return (
      <div className="flex items-center justify-center text-center px-4 py-12">
        <div className="max-w-2xl">
          ...
          <p className="font-serif text-sm tracking-[0.2em] text-muted-foreground mb-3 font-light">Containing the</p>
          <p className="font-serif text-xl font-light text-foreground mb-8 tracking-tight">Old and New Testaments</p>
