    ...
    return (
      <div className="flex items-center justify-center text-center px-4 py-4">
        <div className="max-w-2xl">
          <div className="mb-3 h-px bg-foreground/20" />
          <p className="font-serif text-xs tracking-[0.25em] text-muted-foreground mb-2 font-light">THE</p>
          <h1 className="font-serif text-7xl md:text-8xl font-light text-foreground mb-3 leading-tight tracking-tight">
            Holy Bible
          </h1>
          <p className="font-serif text-sm tracking-[0.2em] text-muted-foreground mb-2 font-light">Containing the</p>
          <p className="font-serif text-xl font-light text-foreground mb-4 tracking-tight">Old and New Testaments</p>
          
          <p className="font-serif text-xs tracking-[0.15em] text-muted-foreground mb-3 leading-relaxed font-light">
          ...
          <p className="font-serif text-xs tracking-[0.15em] text-muted-foreground mb-3 font-light">
    ...
    return (
      <div className="flex items-center justify-center text-center px-4 py-4">
        <div className="max-w-2xl">
          ...
          <p className="font-serif text-lg font-light text-foreground mb-4 tracking-tight">
