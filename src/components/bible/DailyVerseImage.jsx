...
export default function DailyVerseImage({ verse, onClick, onToggleNotif, notifEnabled, isOffline }) {
  ...
  // if quality alone can't get under the limit, start shrinking dimensions
  // too (with quality bumped back up a bit, since a smaller image can afford
  ...
  // needlessly degraded.
  const shrinkImageUnderLimit = (file, maxBytes = 2 * 1024 * 1024) => new Promise((resolve, reject) => {
