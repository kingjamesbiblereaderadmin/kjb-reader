    ...
    <div ref={verseRef} onClick={(e) => { if (!uploadingComplete && !showLightbox) onClick(e); }} className={`w-full min-h-[300px] ${gradientClass} border border-border rounded-2xl shadow-lg px-2 sm:px-6 text-center text-white relative flex flex-col ${capturing ? 'pt-20 pb-8' : 'pt-6 pb-6'} ${uploadingComplete ? 'cursor-default' : 'cursor-pointer hover:scale-[1.02] transition-all duration-300 hover:shadow-xl'}`} style={bgStyle}>
      ...
      {showButtons && onToggleNotif && (
        <button
          ...
          className="absolute top-2 left-2 p-1.5 flex items-center justify-center rounded-lg bg-black/40 hover:bg-black/55 transition-colors z-10 touch-manipulation"
        ...
        {!capturing && showButtons ? (
          <>
            <button
              ...
              className="p-1.5 flex items-center justify-center rounded-lg bg-black/40 hover:bg-black/55 transition-colors touch-manipulation"
            ...
            <button
              ...
              disabled={capturing}
              className="p-1.5 flex items-center justify-center rounded-lg bg-black/40 hover:bg-black/55 transition-colors disabled:opacity-50 touch-manipulation"
