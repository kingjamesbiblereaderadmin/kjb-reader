    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background">
      <div className="w-full max-w-3xl mx-auto px-5 sm:px-8 lg:px-12 py-10 pb-24">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-sans text-sm text-muted-foreground">KJB Reader Bot is for those who wish to use the BibleApi from KingJamesBibleReader.com for random, search, daily, and gospel sharing on their Discord servers.</p>
