...
export default function BibleReader() {
  ...
  return (
    <div className={`w-full max-w-[90rem] mx-auto px-4 sm:px-8 lg:px-16 py-3 ${hideHeader ? 'pt-16' : ''}`}>
      ...
      {!hideHeader && (
        <div ref={topRef} className="sticky top-[56px] sm:top-[72px] z-[100] border-b border-border pb-2 pt-2 mb-2 relative shadow-sm before:content-[''] before:absolute before:bottom-full before:left-0 before:right-0 before:h-4 before:bg-background" style={{ backgroundColor: 'hsl(var(--background))' }}>
          <div className="flex flex-wrap items-stretch gap-1.5 w-full">
            ...
            <button
              ...
              className="flex flex-1 items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg bg-primary text-primary-foreground font-sans text-sm font-medium hover:opacity-90 transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] whitespace-nowrap"
            >
            ...
            {!isViewingTitlePage && (
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg bg-secondary text-secondary-foreground font-sans text-sm font-medium hover:bg-accent/20 transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] whitespace-nowrap"
              >
              ...
              <button
                ...
                className={`flex flex-1 items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg font-sans text-sm font-medium transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] whitespace-nowrap ${
                  selectMode
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1 px-3 py-2.5 rounded-lg bg-secondary text-secondary-foreground font-sans text-xs font-medium hover:bg-accent/20 transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] whitespace-nowrap"
              >
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 p-2.5 rounded-lg bg-secondary text-secondary-foreground font-sans text-xs font-medium hover:bg-accent/20 transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] min-w-[44px] whitespace-nowrap"
              >
              ...
              <button
                ...
                title="Select verses"
                className={`flex flex-1 items-center justify-center gap-1.5 p-2.5 rounded-lg font-sans text-xs font-medium transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] min-w-[44px] whitespace-nowrap ${selectMode ? 'bg-primary text-primary-foreground' : 'bg-secondary text-secondary-foreground hover:bg-accent/20'}`}
              >
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 p-2.5 rounded-lg bg-secondary text-secondary-foreground hover:bg-accent/20 transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation min-h-[44px] min-w-[44px] whitespace-nowrap"
              >
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 p-2.5 rounded-lg bg-secondary hover:bg-accent/20 text-foreground disabled:opacity-30 transition-all duration-200 hover:scale-105 active:scale-95 disabled:hover:scale-100 disabled:active:scale-100 touch-manipulation min-h-[44px] min-w-[44px] whitespace-nowrap"
              >
            ...
            {isViewingTitlePage && (
              <>
                <button
                  ...
                  disabled={isFirstChapterFirstBook}
                  title="Previous"
                  className="flex flex-1 items-center justify-center gap-1.5 p-2.5 rounded-lg bg-secondary hover:bg-accent/20 text-foreground disabled:opacity-30 transition-all duration-200 hover:scale-105 active:scale-95 disabled:hover:scale-100 touch-manipulation min-h-[44px] min-w-[44px]"
                >
