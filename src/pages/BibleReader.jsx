...
export default function BibleReader() {
  ...
  return (
    <div className={`w-full max-w-[90rem] mx-auto px-4 sm:px-8 lg:px-16 py-3 ${hideHeader ? 'pt-16' : ''}`}>
      ...
      {!hideHeader && (
        <div ref={topRef} className="sticky top-[56px] sm:top-[72px] z-[100] bg-background border-b border-border pb-2 pt-2 mb-2 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen px-4 sm:px-6 lg:px-12">
