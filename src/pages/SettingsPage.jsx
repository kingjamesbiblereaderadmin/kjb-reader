...
import { Settings, Bell, BellOff, Download, CheckCircle2, AlertCircle, Loader2, Trash2, Smartphone, MonitorSmartphone, Eye, EyeOff, ZoomIn, ZoomOut, Palette, Upload, Crop, Type, ChevronDown, CheckCircle, ExternalLink, Shield, MessageCircle, Instagram, Youtube, RotateCcw, Accessibility, Keyboard, Star, Server, Globe } from 'lucide-react';
...
const WORKER_VERSION = 'v20260626_723';
            ...
            {showInstallHint && (
              <div className="space-y-2 bg-secondary/50 rounded-xl p-4 mt-3">
                ...
                <div className="font-sans text-xs text-muted-foreground space-y-1.5">
                  ...
                  <p>• <strong>Samsung Internet:</strong> The automatic install button won't work here — Samsung's browser doesn't support it. Instead, tap the menu <span className="inline-flex items-center px-1.5 py-0.5 bg-background rounded text-foreground font-medium">(≡)</span> at the bottom, choose <span className="text-foreground font-medium">"Add page to"</span>, then <span className="text-foreground font-medium">"Home screen"</span>.</p>
                  <p>• <strong>Edge:</strong> Open the menu <span className="inline-flex items-center px-1.5 py-0.5 bg-background rounded text-foreground font-medium">(⋯)</span> → <span className="text-foreground font-medium">Apps</span> → <span className="text-foreground font-medium">"Install this site as an app"</span>. If you see <span className="text-foreground font-medium">"App"</span> and <span className="text-foreground font-medium">"Shortcut"</span>, choose <span className="text-foreground font-medium">App</span> — that installs the real app (Shortcut only adds a link). Edge doesn't support the automatic install prompt, so use these manual steps.</p>
