...
const WORKER_VERSION = 'v20260625_528';
            ...
            {showInstallHint && (
              <div className="space-y-2 bg-secondary/50 rounded-xl p-4 mt-3">
                ...
                <div className="font-sans text-xs text-muted-foreground space-y-1.5">
                  ...
                  <p>• <strong>Edge:</strong> The automatic install button won't work here — install Edge manually instead. Open the menu <span className="inline-flex items-center px-1.5 py-0.5 bg-background rounded text-foreground font-medium">(⋯)</span> → <span className="text-foreground font-medium">Apps</span> → <span className="text-foreground font-medium">"Install this site as an app"</span>. If you see <span className="text-foreground font-medium">"App"</span> and <span className="text-foreground font-medium">"Shortcut"</span>, choose <span className="text-foreground font-medium">App</span> — that installs the real app (Shortcut only adds a link).</p>
