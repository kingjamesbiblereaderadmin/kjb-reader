...
const DICT = {
  ...
  // ── KJV TTS lexicon (user-provided batch) ──
  draught: 'draft',
  shew: 'show',
  shewed: 'showd',
  shewing: 'show ing',
  ...
  // ── Genealogy names across all 66 books (standard KJV pronunciations) ──
